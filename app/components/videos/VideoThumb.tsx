...
export default function VideoThumb({title, cover, duration}: VideoThumbProps) {
    ...
    return (
        <div className="pointer-events-none">
            ...
            >
                ...
                {duration && (
                    <div
                        className="pointer-events-none absolute bottom-0 right-0 z-0 bg-black bg-opacity-50 px-2 text-xs font-bold leading-6 text-white"
                    >
                        {timeInHours}
                    </div>
                )}
                <button
                    className="video-preview-button pointer-events-none absolute bottom-0 left-0 z-0 block p-2 md:hidden"
                >
                    <svg
                        width="24"
                        height="25"
